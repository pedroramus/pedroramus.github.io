...
!function(){"use strict";$(document).ready(function(){$("#expand-button").click(function(t){t.preventDefault(),"Expandir"==$("#expand-button").html()?$("#expand-button").html("Ocultar"):$("#expand-button").html("Expandir")})})}();
