...
!function(){"use strict";$(document).ready(function(){$("a.page-scroll").click(function(t){var e=$(this.getAttribute("href"));e.length&&(t.preventDefault(),$("html, body").stop().animate({scrollTop:e.offset().top},1e3))}),$("#menu-button").click(function(t){t.preventDefault(),"none"==$("nav").css("display")?$("#menu-icon").attr("class","fa fa-times"):$("#menu-icon").attr("class","fa fa-bars"),$("#website-content").fadeToggle(),$("nav").slideToggle("slow")}),$("#expand-button").click(function(t){t.preventDefault(),"Expandir"==$(this).html()?$(this).html("Ocultar"):$(this).html("Expandir"),$("#hidden-skills").fadeToggle("slow")})})}();
