...
!function(){"use strict";$(document).ready(function(){$("#expand-button").click(function(t){t.preventDefault(),"Expandir"==$(this).html()?($(this).html("Ocultar"),$("#hidden-skills").css("display","block")):($(this).html("Expandir"),$("#hidden-skills").css("display","none"))})})}();
