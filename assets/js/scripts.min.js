...
!function(){"use strict";$(document).ready(function(){$("#menu-button").click(function(t){t.preventDefault(),"none"==$("nav").css("display")?$("#menu-icon").attr("class","fa fa-times"):$("#menu-icon").attr("class","fa fa-bars"),$("nav").slideToggle("slow")}),$("#expand-button").click(function(t){t.preventDefault(),"Expandir"==$(this).html()?$(this).html("Ocultar"):$(this).html("Expandir"),$("#hidden-skills").fadeToggle("slow")})})}();
