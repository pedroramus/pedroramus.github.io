!function(o){var t=o.document;if(!location.hash&&o.addEventListener){window.scrollTo(0,1);var n=1,e=function(){return o.pageYOffset||"CSS1Compat"===t.compatMode&&t.documentElement.scrollTop||t.body.scrollTop||0},l=setInterval(function(){t.body&&(clearInterval(l),n=e(),o.scrollTo(0,1===n?0:1))},15);o.addEventListener("load",function(){setTimeout(function(){e()<20&&o.scrollTo(0,1===n?0:1)},0)})}}(this);
...
!function(t){"use strict";t.picturefill=function(){for(var e=t.document.getElementsByTagName("div"),a=0,i=e.length;a<i;a++)if(null!==e[a].getAttribute("data-picture")){for(var n=e[a].getElementsByTagName("div"),r=[],l=0,d=n.length;l<d;l++){var c=n[l].getAttribute("data-media");(!c||t.matchMedia&&t.matchMedia(c).matches)&&r.push(n[l])}var u=e[a].getElementsByTagName("img")[0];r.length?(u||(u=t.document.createElement("img"),u.alt=e[a].getAttribute("data-alt"),e[a].appendChild(u)),u.src=r.pop().getAttribute("data-src")):u&&e[a].removeChild(u)}},t.addEventListener?(t.addEventListener("resize",t.picturefill,!1),t.addEventListener("DOMContentLoaded",function(){t.picturefill(),t.removeEventListener("load",t.picturefill,!1)},!1),t.addEventListener("load",t.picturefill,!1)):t.attachEvent&&t.attachEvent("onload",t.picturefill)}(this);
!function(){"use strict";$(document).ready(function(){var e=function(){"none"==$("nav").css("display")?$("#menu-icon").attr("class","fa fa-times"):$("#menu-icon").attr("class","fa fa-bars"),$("nav").slideToggle("slow")};$("a.page-scroll").click(function(e){var a=$(this.getAttribute("href"));a.length&&$("html, body").stop().animate({scrollTop:a.offset().top},1e3)}),$("a.page-scroll-menu").click(function(a){e();var s=$(this.getAttribute("href"));s.length&&$("html, body").stop().animate({scrollTop:s.offset().top},1e3)}),$("#menu-button").click(function(a){a.preventDefault(),e()}),$("#expand-button").click(function(e){e.preventDefault(),"Expandir"==$(this).html()?$(this).html("Ocultar"):$(this).html("Expandir"),$("#hidden-skills").fadeToggle("slow")}),$("#submit-contact-form").click(function(e){e.preventDefault(),$("#alert-message").remove();var a={name:$("#name-form").val(),email:$("#email-form").val(),message:$("#message-form").val()};""==a.name?$("#alert-contact-form").append('<div class="alert alert-danger" id="alert-message" class="division-2rem"><a href class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Atenção!</strong> O campo de NOME não pode ser vazio.</div>'):""==a.email?$("#alert-contact-form").append('<div class="alert alert-danger" id="alert-message" class="division-2rem"><a href class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Atenção!</strong> O campo de EMAIL não pode ser vazio.</div>'):""==a.message?$("#alert-contact-form").append('<div class="alert alert-danger" id="alert-message" class="division-2rem"><a href class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Atenção!</strong> O campo de MESSAGEM não pode ser vazio.</div>'):($("#submit-contact-form").prop("disabled",!0),$("#load-icon").show(),$.ajax({url:"https://pedroramos.herokuapp.com/portfolio-contact",dataType:"json",type:"post",data:a,success:function(e,a,s){$("#alert-contact-form").append('<div class="alert alert-success" id="alert-message" class="division-2rem"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Sucesso!</strong> Obrigado pela sua mensagem. Assim que possível entrarei em contato. Desde já agradeço seu interesse.</div>'),$("#name-form").val(""),$("#email-form").val(""),$("#message-form").val(""),$("#load-icon").hide()},error:function(e,a,s){$("#alert-contact-form").append('<div class="alert alert-danger" id="alert-message" class="division-2rem"><a href class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Desculpe o transtorno!</strong> Sua mensagem não foi enviada. Tente outra vez ou envie-me diretamente através do email <strong>ramuspedro@gmail.com</strong>.</div>'),$("#load-icon").hide()}}))}),$("#alert-contact-form").delegate("a.close","click",function(e){e.preventDefault(),$("#alert-message").remove()})})}();
