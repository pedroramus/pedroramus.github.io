...
!function(){"use strict";$(document).ready(function(){$("#expand-button").click(function(t){t.preventDefault(),"Expandir"==$(this).html()?$(this).html("Ocultar"):$(this).html("Expandir"),$("#hidden-skills").fadeToggle("slow")})})}();
