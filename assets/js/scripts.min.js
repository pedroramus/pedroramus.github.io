...
!function(){"use strict";$(document).ready(function(){var t=function(){"none"==$("nav").css("display")?$("#menu-icon").attr("class","fa fa-times"):$("#menu-icon").attr("class","fa fa-bars"),$("nav").slideToggle("slow")};$("a.page-scroll").click(function(t){var e=$(this.getAttribute("href"));e.length&&$("html, body").stop().animate({scrollTop:e.offset().top},1e3)}),$("a.page-scroll-menu").click(function(e){t();var o=$(this.getAttribute("href"));o.length&&$("html, body").stop().animate({scrollTop:o.offset().top},1e3)}),$("#menu-button").click(function(e){e.preventDefault(),t()}),$("#expand-button").click(function(t){t.preventDefault(),"Expandir"==$(this).html()?$(this).html("Ocultar"):$(this).html("Expandir"),$("#hidden-skills").fadeToggle("slow")}),$("#submit-contact-form").click(function(t){t.preventDefault();var e={name:$("#name-form").val(),email:$("#email-form").val(),message:$("#message-form").val()};console.log(e),$.post("http://localhost:1337/portfolio-contact",e)})})}();
